...
状态：`FLAP-F0_V5_CONTENT_APPROVAL_SUPERSEDED / V6_ECONOMIC_CHANGE_FIX_READY / INDEPENDENT_RETEST_PENDING / IMPLEMENTATION_PAUSED`
...
当前产品转向、永久退役项、参数目录和新阶段计划以文档 44、27～31 为准；发生冲突时最新 Owner 文档 44 优先。旧 G2-G9 不再是当前执行主线。

## 权威顺序

新 Flap 产品发生冲突时按以下顺序判定：

1. [44_FLAP_F0_OWNER_ECONOMIC_MODEL_CHANGE_DECISION.md](./44_FLAP_F0_OWNER_ECONOMIC_MODEL_CHANGE_DECISION.md)；
2. [27_FLAP_PRODUCT_PIVOT_DECISION.md](./27_FLAP_PRODUCT_PIVOT_DECISION.md)；
3. [28_FLAP_PRODUCT_SCOPE_AND_PARAMETER_CATALOG.md](./28_FLAP_PRODUCT_SCOPE_AND_PARAMETER_CATALOG.md)；
4. [29_FLAP_TARGET_ARCHITECTURE.md](./29_FLAP_TARGET_ARCHITECTURE.md) 与 [30_FLAP_F0_F11_EXECUTION_PLAN.md](./30_FLAP_F0_F11_EXECUTION_PLAN.md)；
5. F1 将冻结的 Flap BSC Testnet 地址、ABI、runtime bytecode、交易回执和链上事件；
6. F2 将冻结的 SQL/OpenAPI/Event/State/RBAC/Signer 机器规范；
7. [31_FLAP_LEGACY_RETIREMENT_MATRIX.md](./31_FLAP_LEGACY_RETIREMENT_MATRIX.md)；
8. PANGU2 文档与链上证据仅在解释 Legacy PANGU2 时继续权威。
...
- [45_FLAP_F0_V6_ECONOMIC_CHANGE_SELF_REVIEW.md](./45_FLAP_F0_V6_ECONOMIC_CHANGE_SELF_REVIEW.md)：V6 作者侧静态自审、经济不变量和未执行项；
- [46_FLAP_F0_V6_SUBMISSION_CONTEXT.md](./46_FLAP_F0_V6_SUBMISSION_CONTEXT.md)：V6 单一增量 Commit、Package、手动 Push 和复审身份；
...
F0_STATUS = V6_ECONOMIC_CHANGE_FIX_READY / INDEPENDENT_RETEST_PENDING
...
F0_REMOTE_PUSH = USER_MANUAL_PENDING_AFTER_V6_COMMIT
