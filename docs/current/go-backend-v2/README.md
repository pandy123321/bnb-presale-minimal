...
状态：`FLAP-F0_V6_REVIEW_CHANGES_REQUIRED / V7_P1_REMEDIATION_FIX_READY / INDEPENDENT_RETEST_PENDING / IMPLEMENTATION_PAUSED`
...
当前产品转向、永久退役项、参数目录和新阶段计划以文档 47、44、27～31 为准；文档 47 只裁决外审 Finding，不能覆盖 Owner 产品方向。旧 G2-G9 不再是当前执行主线。

## 权威顺序

新 Flap 产品发生冲突时按以下顺序判定：

1. [47_FLAP_F0_V6_EXTERNAL_REVIEW_ADJUDICATION.md](./47_FLAP_F0_V6_EXTERNAL_REVIEW_ADJUDICATION.md) 与 [49_FLAP_F0_V7_SUBMISSION_CONTEXT.md](./49_FLAP_F0_V7_SUBMISSION_CONTEXT.md)；
2. [44_FLAP_F0_OWNER_ECONOMIC_MODEL_CHANGE_DECISION.md](./44_FLAP_F0_OWNER_ECONOMIC_MODEL_CHANGE_DECISION.md)；
3. [27_FLAP_PRODUCT_PIVOT_DECISION.md](./27_FLAP_PRODUCT_PIVOT_DECISION.md)；
4. [28_FLAP_PRODUCT_SCOPE_AND_PARAMETER_CATALOG.md](./28_FLAP_PRODUCT_SCOPE_AND_PARAMETER_CATALOG.md)；
5. [29_FLAP_TARGET_ARCHITECTURE.md](./29_FLAP_TARGET_ARCHITECTURE.md) 与 [30_FLAP_F0_F11_EXECUTION_PLAN.md](./30_FLAP_F0_F11_EXECUTION_PLAN.md)；
6. F1 将冻结的 Flap BSC Testnet 地址、ABI、runtime bytecode、交易回执和链上事件；
7. F2 将冻结的 SQL/OpenAPI/Event/State/RBAC/Signer 机器规范；
8. [31_FLAP_LEGACY_RETIREMENT_MATRIX.md](./31_FLAP_LEGACY_RETIREMENT_MATRIX.md)；
9. PANGU2 文档与链上证据仅在解释 Legacy PANGU2 时继续权威。
...
- [42_FLAP_F0_V5_REMEDIATION_SELF_REVIEW.md](./42_FLAP_F0_V5_REMEDIATION_SELF_REVIEW.md)：V5 历史小范围修订与作者侧静态自审；已被 V6 Owner 经济变更取代；
- [43_FLAP_F0_V5_SUBMISSION_CONTEXT.md](./43_FLAP_F0_V5_SUBMISSION_CONTEXT.md)：V5 历史 Commit/Package 身份；不得授权 V6 Freeze；
- [44_FLAP_F0_OWNER_ECONOMIC_MODEL_CHANGE_DECISION.md](./44_FLAP_F0_OWNER_ECONOMIC_MODEL_CHANGE_DECISION.md)：责任人选择新经济模型、旧机制保留边界和 V5 审核失效范围；
- [45_FLAP_F0_V6_ECONOMIC_CHANGE_SELF_REVIEW.md](./45_FLAP_F0_V6_ECONOMIC_CHANGE_SELF_REVIEW.md)：V6 历史作者侧自审；已被 V7 修订取代；
- [46_FLAP_F0_V6_SUBMISSION_CONTEXT.md](./46_FLAP_F0_V6_SUBMISSION_CONTEXT.md)：V6 已验证历史 Commit/Package 身份；内容审核为 CHANGES_REQUIRED；
- [47_FLAP_F0_V6_EXTERNAL_REVIEW_ADJUDICATION.md](./47_FLAP_F0_V6_EXTERNAL_REVIEW_ADJUDICATION.md)：V6 远程证据关闭、3 个 P1 二次裁决和 P3 证据限制；
- [48_FLAP_F0_V7_P1_REMEDIATION_SELF_REVIEW.md](./48_FLAP_F0_V7_P1_REMEDIATION_SELF_REVIEW.md)：V7 三项 P1 修订与作者侧静态自审；
- [49_FLAP_F0_V7_SUBMISSION_CONTEXT.md](./49_FLAP_F0_V7_SUBMISSION_CONTEXT.md)：V7 单一增量 Commit、Package、手动 Push 和复审身份；
...
F0_STATUS = V7_P1_REMEDIATION_FIX_READY / INDEPENDENT_RETEST_PENDING
...
F0_REMOTE_PUSH = USER_MANUAL_PENDING_AFTER_V7_COMMIT
