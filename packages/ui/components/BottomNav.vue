...
function isActive(t: typeof tabs[0]) { return t.id === "home" ? route.path === "/" : route.path.startsWith(t.route); }
</script>
<template>
  <nav class="bottom-nav">
    <button v-for="t in tabs" :key="t.id" class="nav-item" :class="{ active: isActive(t) }" @click="$router.push(t.route)">
