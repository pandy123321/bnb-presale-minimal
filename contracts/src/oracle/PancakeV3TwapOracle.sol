...
contract PancakeV3TwapOracle is IPangu2TwapOracle {
        ...
        returns (Quote memory quote)
    {
        ...
        uint160 splDelta;
        unchecked {
            // Pancake V3 cumulative observations are intentionally allowed to wrap.
        ...
        uint256 deviationBps = twapUnitQuote == 0 ? type(uint256).max : FullMath.mulDiv(difference, BPS_DENOMINATOR, twapUnitQuote);
