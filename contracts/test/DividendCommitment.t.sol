...
contract DividendCommitmentTest is Pangu2IntegrationTest {
    ...
    function testCommitmentIsDomainSeparatedByChainAndDistributor() public {
        ...
        DividendDistributor other = new DividendDistributor(
            address(token), address(costBasis), address(this), PUBLISHER, EMERGENCY
        );
    ...
    function _commitment(uint256 epochId, address account, uint256 amount)
        internal
        view
        returns (IDividendDistributor.EpochCommitment memory)
    {
